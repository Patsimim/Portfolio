  ...
  return (
    ...
    >
      <style jsx>{`
        ...
        .spark:nth-child(1) { top: 20%; left: 15%; animation-delay: 0.1s; }
        .spark:nth-child(2) { top: 30%; right: 20%; animation-delay: 0.2s; }
        .spark:nth-child(3) { bottom: 25%; left: 25%; animation-delay: 0.3s; }
        .spark:nth-child(4) { bottom: 35%; right: 15%; animation-delay: 0.4s; }
        .spark:nth-child(5) { top: 50%; left: 50%; animation-delay: 0.5s; }
        .spark:nth-child(6) { top: 15%; left: 60%; animation-delay: 0.6s; }
        .spark:nth-child(7) { bottom: 20%; left: 70%; animation-delay: 0.7s; }
